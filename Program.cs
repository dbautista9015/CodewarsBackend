...
builder => {builder.WithOrigins("https://codestackcodewars.azurewebsites.net","https://reservekatas.azurewebsites.net","http://localhost:3000", "http://localhost:3001", "http://localhost:3002", "http://localhost:3003")
    .AllowAnyHeader()
    .AllowAnyMethod();
});
});
